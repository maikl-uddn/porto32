                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-1">
                        <div className="flex items-center space-x-3 mb-4">
                            ...
                            <span className="text-xl font-semibold text-gray-900 dark:text-white">IKMALUDDIN</span>
                        </div>
                        ...
                        <form className="space-y-4">
                            <div>
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 text-sm border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent transition-all duration-300 outline-none bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                                />
                            </div>
                            <button
                                type="submit"
                                className="w-full bg-gray-900 dark:bg-blue-600 text-white px-4 py-2.5 text-sm font-medium rounded-lg hover:bg-gray-800 dark:hover:bg-blue-500 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 dark:focus:ring-blue-500"
                            >
                                Berlangganan
                            </button>
                        </form>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
                        ...
                        <div className="text-center md:text-left">
                            <p className="text-xs text-gray-500 dark:text-gray-400">
                                &copy; 2026 Ikmaluddin. All rights reserved.
                            </p>
                        </div>
